    ...
    def eventFilter(self, objeto, evento):
        if objeto is self.boton:
            ...
            if (
                ...
                # Coloca el botón encima de los demás.
                self.boton.raise_()
...
class GestionUsuario(QtWidgets.QWidget):
    def __init__(self, ventana_anterior=None):
        ...
        # Lista compartida de los botones.
        self.botones_menu = [
            self.btn_editar,
            self.btn_eliminar,
            self.btn_visualizar,
        ...
        # Efecto de agrandamiento y sombra.
        self.efectos_hover = [
            EfectoHoverBoton(
                boton=boton,
                factor=1.035,
        ...
        # Espera a que Qt y BotonesResponsivos coloquen
    ...
    def actualizar_hover_botones(self):
        """
        Actualiza la posición original utilizada por
        cada animación después de redimensionar.
        """
    ...
    def resizeEvent(self, event):
        ...
        # El frame debe ocupar toda la ventana.
        ...
        # Actualiza la posición utilizada por el hover
