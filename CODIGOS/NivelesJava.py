...
class PintorImagenBoton(QtCore.QObject):
    ...
    def recortar_transparencia(pixmap):
        ...
        cada píxel desde Java. El recorrido manual queda solamente como
...
class NivelesJava(CofreDiplomaMixin, QtWidgets.QWidget):
    """Menú de Java con desbloqueo progresivo de niveles."""
    ...
    def __init__(
        ...
        # De esta manera NivelesJava termina de construirse rápidamente y
    ...
    def crear_indice_imagenes_botones(self):
        """
        Guarda todas las rutas asociadas a cada nombre de imagen.

        Esto permite resolver nombres compartidos como Bloqueado, prueba
        y PruebaBloqueada sin seleccionar por accidente el diseño de otro
        lenguaje.
        """
        indice = {}
    ...
    @staticmethod
    def _ruta_contiene_java(ruta):
        """Indica si alguna carpeta de la ruta pertenece a Java."""
        partes = [
    ...
    @staticmethod
    def _puntaje_color_java(ruta):
        """
        Prioriza los diseños crema, naranja y dorado usados por Java.

        Solo se utiliza como respaldo cuando las carpetas de los archivos
        no contienen la palabra Java.
        """
        imagen = QtGui.QImage(
            str(ruta)
        )
        ...
        for y in range(imagen.height()):
            for x in range(imagen.width()):
                ...
                # Premia tonos naranja, dorado y crema.
                if (
                    rojo > 150
                    and verde > 70
                    and azul < 150
                ...
                # Penaliza el azul dominante propio de Python.
                if (
                    azul > rojo + 18
                    and azul > verde + 8
                ):
    ...
    def obtener_ruta_imagen_boton(self, nombre_imagen):
        # El índice se crea únicamente al aplicar la primera imagen.
        # Esto evita recorrer la carpeta antes de iniciar la transición.
        ...
        rutas = self.indice_imagenes_botones.get(
            clave,
            [],
        )
        ...
        # Primera prioridad: archivos dentro de una carpeta de Java.
        rutas_java = [
            ruta
            for ruta in rutas
            if self._ruta_contiene_java(ruta)
        ]

        if rutas_java:
            return max(
                rutas_java,
                key=self._puntaje_color_java,
            )

        # Respaldo: selecciona la imagen más cercana a la paleta de Java.
        return max(
            rutas,
            key=self._puntaje_color_java,
        )
    ...
    def consultar_progreso_java(self):
        ...
        if hasattr(
            ...
            try:
                ...
                print(
                    "[NIVELES JAVA] No se pudo consultar "
    ...
    def nombre_imagen_nivel_completado(numero_nivel):
        # BotonJava_1, BotonJava_2, ..., BotonJava_5.
        return f"BotonJava_{numero_nivel}"

    @staticmethod
    def nombre_imagen_nivel_desbloqueado(numero_nivel):
        # BotonDesJava_1, BotonDesJava_2, ..., BotonDesJava_5.
        return f"BotonDesJava_{numero_nivel}"
    ...
    def cargar_estado_niveles(self):
        ...
        la base de datos se ejecuta en QThreadPool.
        """
    ...
    def _al_fallar_carga_progreso(self, detalle):
        ...
        print(
            "[NIVELES JAVA] No se pudo cargar el progreso "
            "en segundo plano:",
            detalle,
        )
    ...
    def abrir_nivel_1(self):
        self.abrir_nivel_java(1)

    def abrir_nivel_2(self):
        self.abrir_nivel_java(2)

    def abrir_nivel_3(self):
        self.abrir_nivel_java(3)

    def abrir_nivel_4(self):
        self.abrir_nivel_java(4)

    def abrir_nivel_5(self):
        self.abrir_nivel_java(5)

    def abrir_prueba_final(self):
        self.abrir_nivel_java(6)

    def abrir_nivel_java(self, numero_nivel):
        if self.nivel_en_ejecucion:
            return
